export const QnA_Data = [
      {
            id: 1,
            question: 'ما معنى الكلمة (الصلاة) لغة؟',
      ...
      {
            id: 4,
            question: 'هل كل مصلًّ سيتساوى مع غيره فى أجر الصلاة؟',
            optionAns: ['نعم', 'لا']
      },
      {
            id: 5,
            question: 'كم تنقسم الصلاة المفروضة؟',
            optionAns: ['قسمتين', 'خمسة أقسام', 'تسعة أقسام', 'أربعة أقسام']
      },
      {
            id: 6,
      ...
      {
            id: 7,
            question: 'ما الدليل على وجوب الصلاة من أية سورة منها؟',
            optionAns: ['سورة آل عمران', 'سورة الناس', 'سورة النساء', 'سورة الفتح']
      },
      {
            id: 8,
      ...
      {
            id: 9,
            question: 'كم أنواع الصلوات المشروعات لنا؟',
            optionAns: ['ثلاثة أنواع', 'عشرة أنواع', 'نوعان', 'ستة أنواع']
      },
      {
            id: 10,
      ...
      {
            id: 11,
            question: 'ما معنى الصلاة عند الملائكة؟',
